...
//                                        echo "RK2 addcell( $row, $column, ".$info['string'].", ".$info." );<br>";
					break;
				...
				case SPREADSHEET_EXCEL_READER_TYPE_NUMBER:
					...
					$info = $this->_getCellDetails($spos,$numValue,$column);
					$this->addcell($row, $column, $info['string'], $info);
//                                        echo "number addcell( $row, $column, ".$info['string'].", $info );<br>";
					break;
...
//                if((double)($string) >= 1000) 
//                    echo " MOTHER OF GOOOD ".$string." row: $row col: $col info: $info<br><br>";
